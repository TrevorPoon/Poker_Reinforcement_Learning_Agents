...
dqn_paths = {
        'model': os.getcwd() + f'/model/a2c.dump',
        'optimizer': os.getcwd() + f'/model/a2c_optim.dump'
    }

training_agent = A2CPlayer(dqn_paths['model'], dqn_paths['optimizer'], True)
...
plt.plot(vpip_history, label='A2C Player VPIP')
...
plt.legend()
plt.grid()
plt.savefig('images/A2C_vs_Honest_vpip_history.png')
plt.show()